  ...
  return (
    <div className="dashboard-overview">
      ...
      <p style={{ fontSize: '1.1rem', color: '#444', marginTop: '1rem' }}>
        ...
        {role === 'profesor'
          ? 'Aquí podrás gestionar tus asignaturas, interactuar con tus estudiantes y aprovechar la inteligencia artificial para mejorar la experiencia educativa.'
      ...
      <ul style={{ margin: '2rem auto', maxWidth: 400, textAlign: 'left', color: '#555', fontSize: '1rem' }}>
        <li>{role === 'profesor' ? 'Crear y gestionar asignaturas' : 'Consultar y gestionar tus asignaturas'}</li>
