-- Migración para corregir la función match_fragments SIN índice vectorial problemático
-- Fecha: 2024-01-XX
...
-- Crear solo índices básicos (sin el índice vectorial que causa problemas de memoria)
...
'Función para buscar fragmentos similares usando pgvector para el sistema RAG de EDUIA - Sin índice vectorial para evitar problemas de memoria'; 